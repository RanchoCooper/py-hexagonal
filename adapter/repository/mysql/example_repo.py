"""
MySQL example repository implementation.
"""
...
from adapter.repository.mysql.client import MySQLClient
from adapter.repository.mysql.entity.example import ExampleEntity
from domain.model.example import Example
from domain.repo.example import ExampleRepository


class MySQLExampleRepository(ExampleRepository):
    """MySQL implementation of the example repository."""
    ...
    def find_by_id(self, example_id: UUID) -> Optional[Example]:
        ...
        Raises:
            MySQLError: If there's a problem with the database
        """
        try:
            with self.mysql_client.session() as session:
            ...
            raise MySQLError(f"Failed to find example by ID: {e}", e)
    ...
    def find_all(self) -> List[Example]:
        ...
        try:
            ...
            raise MySQLError(f"Failed to find all examples: {e}", e)
    ...
    def find_by_name(self, name: str) -> Optional[Example]:
        ...
        try:
            ...
            raise MySQLError(f"Failed to find example by name: {e}", e)
    ...
    def save(self, example: Example) -> Example:
        ...
        try:
            ...
            raise MySQLError(f"Failed to save example: {e}", e)
    ...
    def delete(self, example_id: UUID) -> None:
        ...
        try:
            ...
            raise MySQLError(f"Failed to delete example: {e}", e) 