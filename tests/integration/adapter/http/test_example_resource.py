...
class TestExampleResource(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Use a patch to provide the mocked service to the resources
        self.resources_patch = patch.dict(
            'adapter.http.resources.example_resource.__dict__',
            {'example_app_service': self.example_app_service}
        )
        self.resources_patch.start()
        
        api.add_resource(ExampleListResource, '/api/examples')
        api.add_resource(ExampleResource, '/api/examples/<string:example_id>')
    ...
    def test_get_example_not_found(self):
        ...
        self.example_app_service.get_example.side_effect = EntityNotFoundError("Example", example_id)
    ...
    def test_update_example_not_found(self):
        ...
        self.example_app_service.update_example.side_effect = EntityNotFoundError("Example", example_id)
    ...
    def test_update_example_name_exists(self):
        ...
        self.example_app_service.update_example.side_effect = ExampleNameAlreadyExistsError(name)
    ...
    def test_create_example_name_exists(self):
        ...
        self.example_app_service.create_example.side_effect = ExampleNameAlreadyExistsError(name)
